    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-green-50">
        <div className="w-full max-w-md rounded-2xl shadow-xl p-8 backdrop-blur-sm border bg-white/80 border-emerald-100">
          ...
          <h2 className="text-2xl font-bold mb-2 flex justify-center items-center text-slate-900">Sign in</h2>
          <p className="text-sm mb-6 flex justify-center items-center text-slate-600">Welcome back to AyurSutra!</p>
          ...
          <form className='flex flex-col gap-4' onSubmit={handleSignin}>
            ...
            <div>
              ...
              <div className="flex justify-end">
                <Link to="/forgot-password" className="text-xs hover:underline font-medium mt-1 cursor-pointer text-emerald-600 hover:text-emerald-700">Forgot password?</Link>
              </div>
            </div>
            {error && (
