      ...
      <div className="rounded-xl border border-emerald-100 bg-emerald-50/50 p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[13px] font-medium tracking-tight text-emerald-900">Abhyanga Therapy</span>
          </div>
          <span className="text-[12px] text-emerald-700">10:00 AM</span>
        </div>
        <div className="mt-2 flex items-center gap-2 text-[12px] text-slate-600">
          ...
          <span>Wellness Center • Room A2</span>
        </div>
        <div className="mt-3 flex items-center gap-2">
          ...
          <button className="inline-flex items-center gap-1.5 text-[12px] px-2.5 py-1.5 rounded-lg border border-transparent hover:border-slate-200 text-slate-700 bg-emerald-100/60 hover:bg-emerald-100 transition">
