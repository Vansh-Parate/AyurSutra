    ...
    <section id="features" className="relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="group rounded-xl bg-white p-5 ring-1 ring-zinc-200 hover:ring-emerald-200 transition-all hover:-translate-y-0.5">
            <div className="flex items-center justify-between">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" data-lucide="arrow-up-right" className="lucide lucide-arrow-up-right h-4 w-4 text-zinc-400 group-hover:text-emerald-600 transition-colors"></svg>
            </div>
            <h3 className="mt-3 text-[16px] font-semibold tracking-tight text-zinc-900">AI scheduling</h3>
            <p className="mt-1.5 text-sm text-zinc-600">Reduce bottlenecks with automated slots, resource allocation, and reminders.</p>
          </div>
          ...
          <div className="group rounded-xl bg-white p-5 ring-1 ring-zinc-200 hover:ring-emerald-200 transition-all hover:-translate-y-0.5">
            ...
            <h3 className="mt-3 text-[16px] font-semibold tracking-tight text-zinc-900">Personalized recommendations</h3>
            <p className="mt-1.5 text-sm text-zinc-600">Personalized treatment plans guided by dosha profiling and evidence.</p>
          </div>
          ...
          <div className="group rounded-xl bg-white p-5 ring-1 ring-zinc-200 hover:ring-emerald-200 transition-all hover:-translate-y-0.5">
            ...
            <h3 className="mt-3 text-[16px] font-semibold tracking-tight text-zinc-900">Progress tracking</h3>
            <p className="mt-1.5 text-sm text-zinc-600">Track outcomes with simple check-ins, symptoms, sleep, and stress trends.</p>
          </div>
          ...
          <div className="group rounded-xl bg-white p-5 ring-1 ring-zinc-200 hover:ring-emerald-200 transition-all hover:-translate-y-0.5">
            ...
            <h3 className="mt-3 text-[16px] font-semibold tracking-tight text-zinc-900">Admin analytics</h3>
            <p className="mt-1.5 text-sm text-zinc-600">Clinic-wide insights on capacity, outcomes, and satisfaction—at a glance.</p>
          </div>
        </div>
      </div>
    </section>
