...
import { ArrowRight, Sparkles, CalendarClock, Sparkles as SparklesIcon, Activity, ShieldCheck, Leaf } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 py-16 md:py-20">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <a href="#features" className="inline-flex items-center justify-center gap-2 rounded-md bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm ring-1 ring-emerald-500 hover:bg-emerald-700 hover:ring-emerald-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/60 cursor-pointer active:scale-95">
                Explore features
                <ArrowRight className="h-4 w-4" />
              </a>
              <a href="#assessment" className="inline-flex gap-2 ring-1 ring-zinc-200 hover:bg-white/70 hover:ring-emerald-200 transition-all duration-200 text-sm font-medium text-emerald-900 rounded-md pt-2.5 pr-4 pb-2.5 pl-4 items-center justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:ring-offset-1 active:scale-95">
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <p className="text-xs text-zinc-600">
                Trusted by clinics and wellness centers worldwide
              </p>
            </div>
          </div>
            ...
            <div className="relative mx-auto max-w-lg">
              <div className="rounded-xl bg-white/80 backdrop-blur ring-1 ring-zinc-200 shadow-sm p-4">
                ...
                <div className="grid grid-cols-3 gap-3 pt-3">
                  <div className="col-span-2 rounded-lg border border-zinc-200 p-3 hover:border-emerald-200 transition-all duration-200 cursor-pointer group">
                    ...
                    <ul className="mt-2 space-y-2">
                      <li className="flex items-center justify-between text-xs text-zinc-600">
                        <span className="">09:00 - Abhyanga</span>
                        <span className="text-emerald-700 font-medium">Room 2</span>
                      </li>
                      <li className="flex items-center justify-between text-xs text-zinc-600">
                        <span className="">10:30 - Shirodhara</span>
                  ...
                  <div className="rounded-lg border border-zinc-200 p-3 hover:border-emerald-200 transition-all duration-200 cursor-pointer group">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="col-span-3 rounded-lg border border-zinc-200 p-3 hover:border-emerald-200 transition-all duration-200 cursor-pointer group">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-medium text-zinc-700">Progress</span>
                      <Activity className="h-4 w-4 text-emerald-600" />
                    </div>
                    <div className="mt-3 grid grid-cols-3 gap-2">
                      <div className="rounded-md bg-emerald-50 text-emerald-900 px-2 py-2 text-[11px] ring-1 ring-emerald-100">
                        Sleep +18%
                      </div>
                      <div className="rounded-md bg-emerald-50 text-emerald-900 px-2 py-2 text-[11px] ring-1 ring-emerald-100">
                        Stress −23%
