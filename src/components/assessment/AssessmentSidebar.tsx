      ...
      <div className="w-full rounded-2xl bg-white/80 backdrop-blur-sm border border-emerald-100 shadow-sm p-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <i data-lucide="leaf" className="h-4 w-4 text-emerald-600"></i>
            <span className="text-[14px] font-medium tracking-tight text-slate-900">Live Dosha Balance</span>
          </div>
          <div className="flex items-center gap-1">
            <div className={`h-2 w-2 rounded-full ${isScoring ? 'bg-emerald-500 animate-pulse' : 'bg-emerald-500'}`}></div>
            <span className="text-[11px] text-emerald-600">{isScoring ? 'Updating...' : 'Live'}</span>
          </div>
        </div>
